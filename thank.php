        ...
        <div id="fh5co-page">
            ...
            <div class="fh5co-hero">
                <div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background: linear-gradient(to right, rgba(255, 60, 0, 0.788) 0%, rgba(253, 173, 0, 0.801) 100%);">
                    <div class="container">
                        <h2 class="text-center" style="color:#fff; margin-top:12px;">Thank You For Complete Your Payment</h2>
                        <div class="row">
                            <div class="col-lg-12" style="background-color: #0000006b; margin-top: 10px; border-radius:30px; color:#fff; padding:30px;">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Taxi Name :</th>
                                        <td><?php echo $_SESSION['taxiname']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Total Pay :</th>
                                        <td><?php echo $_SESSION['total-cost']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Pickup Date :</th>
                                ...
                                <a href="index2.php" class="btn btn-primary">Go Back</a>
                            </div>
                        </div>
                    </div>
                </div>
