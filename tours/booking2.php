...
$selquery = "SELECT * FROM roundtrip WHERE status = '0'";
...
<body>
    ...
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
            ...
            <div class="container" style="background: linear-gradient(to bottom, #fff, #ECECEC);">
                <h2 class="text-center" style="color:#000; margin-top:12px;">Choose Your Suitable Taxi</h2>
                <div class="row">
