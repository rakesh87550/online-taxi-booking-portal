							...
							<div class="row">
													...
													<form method="POST" action="showcars.php">
														...
														<div class="col-xxs-12 col-xs-6 mt">
															<div class="input-field">
																...
																<select class="cs-select cs-skin-border" name="tdes" id="to-place">
																	...
																	<option value="Jalpaiguri">Jalpaiguri</option>
																	<option value="NJP/Siliguri">NJP/Siliguri</option>
														...
														<div class="col-sm-12 mt col-xs-6 mt">
															<section>
																...
																<select class="cs-select cs-skin-border" name="tcar">
																	<option value="" disabled>Car Types</option>
																	<option value="Alto Car">Alto Car</option>
																	<option value="Wagonr Car">Wagonr Car</option>
																	<option value="Bolero Car">Bolero Car</option>
																	<option value="Innova Car">Innova Car</option>
																	<option value="Xylo Car">Xylo Car</option>
																	<option value="Traveller Car">Traveller Car</option>
																</select>
															</section>
														</div>
														<div class="col-xxs-12 col-xs-6 mt">
														...
														<div class="col-sm-12 mt col-xs-6 mt">
															<section>
																...
																<input type="text" name="email" class="form-control" id="email" placeholder="Enter Your Email" required="true" autocomplete="off" />
															</section>
														</div>
														<div class="col-xs-12">
												...
												<div class="row">
													<form method="POST" action="showcars2.php">
														...
														<div class="col-xxs-12 col-xs-6 mt">
															<section>
																<label for="class">Name:</label>
																<input type="text" name="name" class="form-control" id="name" placeholder="Enetr Yor Name" required="true" />
								...
								<div class="desc2 animate-box">
									<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
										<p>HandCrafted by <a href="index.php" target="_blank" class="fh5co-site-name">BookCab</a></p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
							...
							<p>Best Hot & New Tour Destinations in Dooars. Explore best deals on Hot & New vacation packages at lowest prices with BookCab.</p>
						</div>
					</div>
					<div class="row">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
							...
							<p>Planning a trip today can be confusing and time consuming. BookCab not only arranges the various modes of transportation, but may also be able to save you money with early booking discounts, special fares, hotel deals and travel advisories.</p>
						</div>
