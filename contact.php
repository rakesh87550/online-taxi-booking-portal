	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
				...
				<div class="container">
					...
					<form action="#">
						<div class="row animate-box">
							<div class="col-md-6">
								<h2 class="section-title" style="color:#fc3f06;">Our Address :</h2>
							...
							<div class="col-md-6">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											<textarea name="" class="form-control" id="" cols="30" rows="6" placeholder="Message"></textarea>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
			...
			<div id="map" class="fh5co-map">
				<div>
					<h1 class="text-center">FOR MAP INTEGRATION</h1>
				</div>
